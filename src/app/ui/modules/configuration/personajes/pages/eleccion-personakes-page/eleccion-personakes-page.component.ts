...
@Component({
  selector: 'app-eleccion-personakes-page',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './eleccion-personakes-page.component.html',
  styleUrl: './eleccion-personakes-page.component.css'
})
export class EleccionPersonakesPageComponent {
